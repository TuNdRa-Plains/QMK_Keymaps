...
SPACE_CADET_ENABLE = yes 		# Save space by not using space cadet left/right shift (+350)
...
RGB_MATRIX_ENABLE = yes			# Enable RGB Driver for LEDs
RGB_MATRIX_DRIVER = WS2812		# Define LED Type - SK6812 on Sofle RGB uses same Driver as WS2812.