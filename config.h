...
// OLED settings
	...
	#endif
	#define OLED_LOGO					//Enable to print custom logo on slave side (+108).
	//#define OLED_NO_MASTER				//Disable keyboard pet master OLED rendering and render status on the slave (+96).
